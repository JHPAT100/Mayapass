 ...
 * {@link lista_1.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link lista_1#newInstance} factory method to
 * create an instance of this fragment.
 */
public class lista_1 extends Fragment {
...
public  static String nombre_r,receta;
    ...
    public static lista_1 newInstance(String param1, String param2) {
        lista_1 fragment = new lista_1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerComida=vista.findViewById(R.id.lista_1_1);
        recyclerComida.setLayoutManager(new LinearLayoutManager(getContext()));
        llenarLista();
       adaptador_comida adapter= new adaptador_comida(listaComida);
       //on
       adapter.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               nombre_r=listaComida.get(recyclerComida.getChildAdapterPosition(v)).getNombre();
               receta=listaComida.get(recyclerComida.getChildAdapterPosition(v)).getDescripcion();
               img=listaComida.get(recyclerComida.getChildAdapterPosition(v)).getFoto();
              FragmentTransaction trans = getFragmentManager().beginTransaction();
               trans.replace(R.id.contenedor_principal, new mostrar_todo());
