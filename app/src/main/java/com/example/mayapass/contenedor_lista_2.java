 ...
 * {@link contenedor_lista_2.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link contenedor_lista_2#newInstance} factory method to
 * create an instance of this fragment.
 */
public class contenedor_lista_2 extends Fragment {
...
//Nombre,descripcion,Leyenda
    ...
    int [] imgleyendas ={R.drawable.Leyenda1, R.drawable.Leyenda2, R.drawable.Leyenda3, R.drawable.Leyenda4, R.drawable.Leyenda5,
            R.drawable.Leyenda6,R.drawable.Leyenda7,R.drawable.Leyenda8,R.drawable.Leyenda9};
    ...
    public static contenedor_lista_2 newInstance(String param1, String param2) {
        contenedor_lista_2 fragment = new contenedor_lista_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View vista = inflater.inflate(R.layout.fragment_contenedor_lista_2,container,false);

        list = vista.findViewById(R.id.lista);

        list.setAdapter(new Adaptador_lista_2(this,leyendas,imgleyendas));
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof contenedor_lista_1.OnFragmentInteractionListener) {
            mListener = (contenedor_lista_1.OnFragmentInteractionListener) context;
        } else {
