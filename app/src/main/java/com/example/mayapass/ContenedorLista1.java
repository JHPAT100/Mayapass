...
import com.example.mayapass.adaptador.AdaptadorComida;
 ...
 * {@link ContenedorLista1.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ContenedorLista1#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ContenedorLista1 extends Fragment {
     ...
     * @return A new instance of fragment ContenedorLista1.
     */
    // TODO: Rename and change types and number of parameters
    public static ContenedorLista1 newInstance(String param1, String param2) {
        ContenedorLista1 fragment = new ContenedorLista1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_contenedor_lista1, container, false);
        listaComida=new ArrayList<>();
        recyclerComida= (RecyclerView) vista.findViewById(R.id.listaComida);
        recyclerComida.setLayoutManager(new LinearLayoutManager(getContext()));
        listComida();
        AdaptadorComida adapter=new AdaptadorComida(listaComida);
