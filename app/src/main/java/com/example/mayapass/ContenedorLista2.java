 ...
 * {@link ContenedorLista2.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ContenedorLista2#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ContenedorLista2 extends Fragment {
     ...
     * @return A new instance of fragment ContenedorLista2.
     */
    // TODO: Rename and change types and number of parameters
    public static ContenedorLista2 newInstance(String param1, String param2) {
        ContenedorLista2 fragment = new ContenedorLista2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_contenedor_lista2, container, false);
        listaMitos=new ArrayList<>();
        recyclerMitos= (RecyclerView) vista.findViewById(R.id.listaMitos);
        recyclerMitos.setLayoutManager(new LinearLayoutManager(getContext()));
        listMitos();
        AdaptadorMitos adapter=new AdaptadorMitos(listaMitos);
    ...
    private void listMitos(){

        listaMitos.add(new MitosV("El Mito Maya del Colibrí. ","Los dioses, habían hecho un colibrí.\n" +
                "\n" +
        ...
        listaMitos.add(new MitosV("El mito de la flor de loto","Entre los mitos mayas más populares, nos encontramos con uno muy especial que nos cuenta el origen de la flor de loto de una manera bastante romántica.","Con la selva de Mayab como escenario, un príncipe llamado Chacdziedzib que significa pájaro cardenal se encontraba perdidamente enamorado de la hija del guardián del cenote sagrado, una jovencita que llevaba por nombre Nicté-Há que equivale a flor de loto.\n" +
                "\n" +
        ...
        listaMitos.add(new MitosV("El Génesis Maya","Como en el mito de los “orígenes” de otras culturas, entre los mayas aparece el del silencio y las tinieblas originales","Como en el mito de los “orígenes” de otras culturas, entre los mayas aparece el del silencio y las tinieblas originales. Nada existe y es la palabra la que dará origen al Universo. De ello se encargan los progenitores, entre los que se cuentan Gucumatz y Hurakán, el Corazón del Cielo, además de Ixpiyacoc e Ixmucané, abuelos del Alba.\n" +
