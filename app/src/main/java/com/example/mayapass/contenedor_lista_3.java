 ...
 * {@link contenedor_lista_3.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link contenedor_lista_3#newInstance} factory method to
 * create an instance of this fragment.
 */
public class contenedor_lista_3 extends Fragment {
    ...
    private contenedor_lista_3.OnFragmentInteractionListener mListener;


    private RecyclerView list;
    private ListView lista;
    private Adaptador_lista_3 adaptador;



    String mitos[][]={
            {"El Mito Maya del Colibrí. ","Los dioses, habían hecho un colibrí.\n" +
                    "\n" +
                    "Era tan frágil y tan ligero el colibrí que podía acercarse a las flores más delicadas sin mover uno solo de sus pétalos. ","Los mayas, más viejos y sabios, cuentan que los dioses crearon todas las cosas de la Tierra. Y a cada animal, a cada árbol y a cada piedra le encargaron un trabajo. Pero, cuando ya habían terminado, notaron que no había nadie encargado de llevar los deseos y los pensamientos de un lado a otro.\n" +
                    "\n" +
            ...
            {"El mito de la flor de loto","Entre los mitos mayas más populares, nos encontramos con uno muy especial que nos cuenta el origen de la flor de loto de una manera bastante romántica.","Con la selva de Mayab como escenario, un príncipe llamado Chacdziedzib que significa pájaro cardenal se encontraba perdidamente enamorado de la hija del guardián del cenote sagrado, una jovencita que llevaba por nombre Nicté-Há que equivale a flor de loto.\n" +
                    "\n" +
        ...
        {"El Génesis Maya","Como en el mito de los “orígenes” de otras culturas, entre los mayas aparece el del silencio y las tinieblas originales","Como en el mito de los “orígenes” de otras culturas, entre los mayas aparece el del silencio y las tinieblas originales. Nada existe y es la palabra la que dará origen al Universo. De ello se encargan los progenitores, entre los que se cuentan Gucumatz y Hurakán, el Corazón del Cielo, además de Ixpiyacoc e Ixmucané, abuelos del Alba.\n" +
        ...
        int [] imgm ={R.drawable.Mito1, R.drawable.Mito2, R.drawable.Mito3, R.drawable.Mito4, R.drawable.Mito5,
            R.drawable.Mito6,R.drawable.Mito7};
    ...
    public static contenedor_lista_3 newInstance(String param1, String param2) {
        contenedor_lista_3 fragment = new contenedor_lista_3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View vista = inflater.inflate(R.layout.fragment_contenedor_lista_3,container,false);

        list = vista.findViewById(R.id.lista);

        list.setAdapter(new Adaptador_lista_3(this,mitos,imgm));
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof contenedor_lista_3.OnFragmentInteractionListener) {
            mListener = (contenedor_lista_3.OnFragmentInteractionListener) context;
        } else {
