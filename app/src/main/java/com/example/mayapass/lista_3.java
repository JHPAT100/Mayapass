...
import com.example.mayapass.adapter.adaptador_leyendas;
...
public class lista_3 extends Fragment {
...
public  static String nombre_r,receta;
    ...
    public static lista_3 newInstance(String param1, String param2) {
        lista_3 fragment = new lista_3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerLeyendas=vista.findViewById(R.id.lista_1_1);
        recyclerLeyendas.setLayoutManager(new LinearLayoutManager(getContext()));
        llenarLista();
       adaptador_leyendas adapter= new adaptador_leyendas(listaLeyendas);
       //on
       adapter.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               nombre_r=listaLeyendas.get(recyclerLeyendas.getChildAdapterPosition(v)).getNombre();
               receta=listaLeyendas.get(recyclerLeyendas.getChildAdapterPosition(v)).getDescripcion();
               img=listaLeyendas.get(recyclerLeyendas.getChildAdapterPosition(v)).getFoto();
              FragmentTransaction trans = getFragmentManager().beginTransaction();
               trans.replace(R.id.contenedor_principal, new mostrar_l());
  ...
  //
        listaLeyendas.add(new Leyendas("Dziú y el maíz","La leyenda se centra en Dziú, un pájaro que fue reconocido por su valentía.\nCuenta la leyenda que el Dios del agua y el Dios del fuego querían incendiar los cultivos para tener tierras fértiles e iniciar desde cero… “una mañana, Chaac, el Señor de la Lluvia, sintió deseos de pasear y quiso recorrer los campos de El Mayab. Chaac salió muy contento, seguro de que encontraría los cultivos fuertes y crecidos, pero apenas llegó a verlos, su sorpresa fue muy grande, pues se encontró con que las plantas estaban débiles y la tierra seca y gastada. Al darse cuenta de que las cosechas serían muy pobres, Chaac se preocupó mucho. Luego de pensar un rato, encontró una solución: quemar todos los cultivos, así la tierra recuperaría su riqueza y las nuevas siembras serían buenas\n" +
        ...
        listaLeyendas.add(new Leyendas("La creación de la Tierra","Según la leyenda maya sobre la creación de la tierra, antes de la existencia de la misma existían sólo dos dioses: Tepeu y Gucumatz. Ellos fueron quienes se unieron para crear el mundo.\nUn buen día, las aves de la tierra del Mayab prepararon un suntuoso banquete en honor de su rey, el pavo real. Todos los pájaros fueron invitados a la fiesta, y se nombró una comisión especial para escoltar a Tunkuluchú, el búho.\n" +
        ...
        listaLeyendas.add(new Leyendas("Cuando el Tunkuluchú canta…","La leyenda narra la historia de un ave misteriosa y solitaria que sobrevuela las ruinas de Mayab, a la que llaman Tukulunchú. Con su canto anuncia la muerte, por lo que todos le temen.\n El Mayab vive un ave misteriosa, que siempre anda sola y vive entre las ruinas. Es el tecolote o tunkuluchú, quien hace temblar al maya con su canto, pues todos saben que anuncia la muerte.\n" +
